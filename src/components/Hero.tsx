...
const Hero = () => {
  ...
  return <section id="hero" className="min-h-screen flex items-center justify-center px-6 lg:px-8 relative" style={{
    ...
    backgroundRepeat: "no-repeat"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex justify-center lg:justify-end animate-fade-in">
            <div className="relative">
              <div className="w-80 h-80 lg:w-96 lg:h-96 rounded-2xl overflow-hidden bg-portfolio-card border border-portfolio-card/50 shadow-2xl backdrop-blur-sm bg-portfolio-dark/30">
                <img alt="Fábio Catusso" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300" src="/lovable-uploads/b5942df2-d369-4cef-9c16-917721a0698b.jpg" />
              </div>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <button onClick={scrollToAbout} className="p-2 rounded-full border border-portfolio-card hover:border-portfolio-blue transition-colors duration-200 backdrop-blur-sm bg-portfolio-dark/30">
